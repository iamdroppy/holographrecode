...
namespace Ion.HabboHotel.Client
{
    public partial class ClientMessageHandler
    {
        ...
        private void SetFrontPageListening()
        {
            ...
            int hideFull = Request.PopFixedInt32();
            int cataID = Request.PopFixedInt32();
            int type = Request.PopFixedInt32();
            string name = "todo";
            ...
            Response.AppendInt32(hideFull);
            Response.AppendInt32(cataID);
            Response.AppendInt32(type);
            Response.AppendString(name);
            Response.Append(Convert.ToChar(2));
            Response.AppendInt32(0);
            Response.AppendInt32(10000);
            //Response.AppendInt32(parentID);
            ...
            */
            ...
            //Response.Append("HKHPublic RoomsLucyIsBestHXDghabbo clubHIRCITrading RoomsHHH");
        ...
        {
            mRequestHandlers[150] = new RequestHandler(SetFrontPageListening);
